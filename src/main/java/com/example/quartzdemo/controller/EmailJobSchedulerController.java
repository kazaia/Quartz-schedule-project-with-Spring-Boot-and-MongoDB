...
import com.example.quartzdemo.dto.ScheduleEmailRequest;
import com.example.quartzdemo.dto.ScheduleEmailResponse;
...
public class EmailJobSchedulerController {
    ...
    public ResponseEntity<ScheduleEmailResponse> scheduleEmail(@Valid @RequestBody ScheduleEmailRequest scheduleEmailRequest) {
        try {
            ...
            String subject =  scheduleEmailRequest.getSubject();

            if(dateTime.isBefore(ZonedDateTime.now()) || subject.isEmpty() || subject == null ) {
